...
impl Instruction {
    pub fn from_byte(byte: u8) -> Option<Instruction> {
        match byte {
            ...
            0xb6 => Some(Instruction::Or(ArithmeticTarget::HLH)),
            ...
            0xbe => Some(Instruction::Cp(ArithmeticTarget::HLH)),
            0xbf => Some(Instruction::Cp(ArithmeticTarget::A)),
            // Stack manipulation
            0xc0 => Some(Instruction::Ret(JumpTest::NotZero)),
            0xc1 => Some(Instruction::Pop(ArithmeticTarget::BC)),
            // CHECKME
            ...
            0xd1 => Some(Instruction::Pop(ArithmeticTarget::DE)),
            ...
            0xe1 => Some(Instruction::Pop(ArithmeticTarget::HL)),
            ...
            0xf1 => Some(Instruction::Pop(ArithmeticTarget::AF)),
    ...
    pub fn from_prefixed_byte(byte: u8) -> Option<Instruction> {
        match byte {
            ...
            0x06 => Some(Instruction::Rlc(ArithmeticTarget::HLH)),
            ...
            0x0e => Some(Instruction::Rrc(ArithmeticTarget::HLH)),
            ...
            0x16 => Some(Instruction::Rl(ArithmeticTarget::HLH)),
            ...
            0x1e => Some(Instruction::Rr(ArithmeticTarget::HLH)),
            ...
            0x26 => Some(Instruction::Sla(ArithmeticTarget::HLH)),
            ...
            0x2e => Some(Instruction::Sra(ArithmeticTarget::HLH)),
